...
export class MultiplyBasicNode extends GenericImageNode {
    constructor(parent, x, y) {
        super(parent, x, y);
        this.central_element.textContent = "MULTIPLY";
                    ...
                    case "image":
                        switch (this.inputtype2) {
                            case "image":
                                ...
                                ctxii.drawImage(GPUImageImageMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            case "mask":
                                ...
                                ctxim.drawImage(GPUImageImageMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            case "colour":
                                ...
                                ctxic.drawImage(GPUImageColourMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            case "number":
                                ...
                                ctxin.drawImage(GPUImageNumberMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            default:
                                break;
                    ...
                    case "mask":
                        switch (this.inputtype2) {
                            case "image":
                                ...
                                ctxmi.drawImage(GPUImageImageMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            case "mask":
                                ...
                                ctxmm.drawImage(GPUImageImageMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            case "colour":
                                ...
                                ctxmc.drawImage(GPUImageColourMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            case "number":
                                ...
                                ctxmn.drawImage(GPUImageNumberMult(this.parent.gpu, this.inputvalue1, this.inputvalue2), 0, 0);
                                out = this.canvas;
                                break;
                            default:
                                break;
                    ...
                    case "colour":
                        switch (this.inputtype2) {
                            case "image":
                                ...
                                ctxci.drawImage(GPUImageColourMult(this.parent.gpu, this.inputvalue2, this.inputvalue1), 0, 0);
                                out = this.canvas;
                                break;
                            case "mask":
                                //mask to colour addition - result is a mask
                                ...
                                ctxcm.drawImage(GPUImageColourMult(this.parent.gpu, this.inputvalue2, this.inputvalue1), 0, 0);
                                out = this.canvas;
                                break;
                            case "colour":
                    ...
                    case "number":
                        switch (this.inputtype2) {
                            case "image":
                                ...
                                ctxni.drawImage(GPUImageNumberMult(this.parent.gpu, this.inputvalue2, this.inputvalue1), 0, 0);
                                out = this.canvas;
                                break;
                            case "mask":
                                //mask to number addition - result is a mask
                                ...
                                ctxnm.drawImage(GPUImageNumberMult(this.parent.gpu, this.inputvalue2, this.inputvalue1), 0, 0);
                                out = this.canvas;
                                break;
                            case "colour":
                                //colour to number addition - result is a colour
...
function GPUImageImageMult(gpu, source1, source2) {
    const w = source1.width;
    const h = source1.height;

    const mult = gpu.createKernel(function(image1, image2) {
...
function GPUImageColourMult(gpu, source, colour) {
    const w = source.width;
    const h = source.height;

    const mult = gpu.createKernel(function(image, colour) {
    ...
    mult(source, [colour.r / 255, colour.g / 255, colour.b / 255]);

    return mult.canvas;
}

function GPUImageNumberMult(gpu, source, number) {
    const w = source.width;
    const h = source.height;

    const mult = gpu.createKernel(function(image, num) {
        const pixel = image[this.thread.y][this.thread.x];
